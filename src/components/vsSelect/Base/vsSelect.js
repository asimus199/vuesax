...
var VsSelect = /** @class */ (function (_super) {
    ...
    VsSelect.prototype.render = function (h) {
        ...
        return h('div', {
            ...
            "class": [{
                    block: this.block
                }, (_h = {}, _h["vs-component--primary"] = !this.danger && !this.success && !this.warn && !this.dark && !this.color, _h), (_j = {}, _j["vs-component--danger"] = !!this.danger, _j), (_k = {}, _k["vs-component--warn"] = !!this.warn, _k), (_l = {}, _l["vs-component--success"] = !!this.success, _l), (_m = {}, _m["vs-component--dark"] = !!this.dark, _m),]
        }, [
            selectContent,
            messageSuccess,
            messageDanger,
